...
enum opt_code
{
  ...
  OPT_mfix_cmse_cve_2021_35465 = 1616,       /* -mfix-cmse-cve-2021-35465 */
  ...
  OPT_mlibarch_ = 1625,                      /* -mlibarch= */
  OPT_mlittle_endian = 1626,                 /* -mlittle-endian */
  OPT_mlong_calls = 1627,                    /* -mlong-calls */
  OPT_mmusl = 1628,                          /* -mmusl */
  OPT_mneon_for_64bits = 1629,               /* -mneon-for-64bits */
  OPT_mpic_data_is_text_relative = 1630,     /* -mpic-data-is-text-relative */
  OPT_mpic_register_ = 1631,                 /* -mpic-register= */
  OPT_mpoke_function_name = 1632,            /* -mpoke-function-name */
  OPT_mprint_tune_info = 1633,               /* -mprint-tune-info */
  OPT_mpure_code = 1634,                     /* -mpure-code */
  OPT_mrestrict_it = 1635,                   /* -mrestrict-it */
  OPT_msched_prolog = 1636,                  /* -msched-prolog */
  OPT_msingle_pic_base = 1637,               /* -msingle-pic-base */
  OPT_mslow_flash_data = 1638,               /* -mslow-flash-data */
  /* OPT_msoft_float = 1639, */              /* -msoft-float */
  OPT_mstructure_size_boundary_ = 1640,      /* -mstructure-size-boundary= */
  OPT_mthumb = 1641,                         /* -mthumb */
  OPT_mthumb_interwork = 1642,               /* -mthumb-interwork */
  OPT_mtls_dialect_ = 1643,                  /* -mtls-dialect= */
  OPT_mtp_ = 1644,                           /* -mtp= */
  OPT_mtpcs_frame = 1645,                    /* -mtpcs-frame */
  OPT_mtpcs_leaf_frame = 1646,               /* -mtpcs-leaf-frame */
  OPT_mtune_ = 1647,                         /* -mtune= */
  OPT_muclibc = 1648,                        /* -muclibc */
  OPT_munaligned_access = 1649,              /* -munaligned-access */
  OPT_mvectorize_with_neon_double = 1650,    /* -mvectorize-with-neon-double */
  OPT_mvectorize_with_neon_quad = 1651,      /* -mvectorize-with-neon-quad */
  OPT_mverbose_cost_dump = 1652,             /* -mverbose-cost-dump */
  OPT_mword_relocations = 1653,              /* -mword-relocations */
  OPT_n = 1654,                              /* -n */
  OPT_name_sort = 1655,                      /* -name-sort */
  OPT_no_canonical_prefixes = 1656,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1657,              /* -no-integrated-cpp */
  OPT_no_pie = 1658,                         /* -no-pie */
  OPT_nocpp = 1659,                          /* -nocpp */
  OPT_nodefaultlibs = 1660,                  /* -nodefaultlibs */
  OPT_nolibc = 1661,                         /* -nolibc */
  OPT_nophoboslib = 1662,                    /* -nophoboslib */
  OPT_nostartfiles = 1663,                   /* -nostartfiles */
  OPT_nostdinc = 1664,                       /* -nostdinc */
  OPT_nostdinc__ = 1665,                     /* -nostdinc++ */
  OPT_nostdlib = 1666,                       /* -nostdlib */
  OPT_o = 1667,                              /* -o */
  OPT_objects = 1668,                        /* -objects */
  OPT_p = 1669,                              /* -p */
  OPT_pass_exit_codes = 1670,                /* -pass-exit-codes */
  /* OPT_pedantic = 1671, */                 /* -pedantic */
  OPT_pedantic_errors = 1672,                /* -pedantic-errors */
  OPT_pg = 1673,                             /* -pg */
  OPT_pie = 1674,                            /* -pie */
  OPT_pipe = 1675,                           /* -pipe */
  OPT_posix = 1676,                          /* -posix */
  ...
  OPT_profile = 1689,                        /* -profile */
  OPT_pthread = 1690,                        /* -pthread */
  OPT_quiet = 1691,                          /* -quiet */
  OPT_r = 1692,                              /* -r */
  OPT_rdynamic = 1693,                       /* -rdynamic */
  ...
  OPT_time = 1773,                           /* -time */
  OPT_time_ = 1774,                          /* -time= */
  OPT_tno_android_cc = 1775,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1776,                 /* -tno-android-ld */
  OPT_traditional = 1777,                    /* -traditional */
  OPT_traditional_cpp = 1778,                /* -traditional-cpp */
  OPT_tree_stats = 1779,                     /* -tree-stats */
  OPT_trigraphs = 1780,                      /* -trigraphs */
  OPT_type_stats = 1781,                     /* -type-stats */
  OPT_u = 1782,                              /* -u */
  OPT_undef = 1783,                          /* -undef */
  OPT_v = 1784,                              /* -v */
  OPT_version = 1785,                        /* -version */
  OPT_w = 1786,                              /* -w */
  OPT_wrapper = 1787,                        /* -wrapper */
  OPT_x = 1788,                              /* -x */
  OPT_z = 1789,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
