...
enum opt_code
{
  ...
  OPT_foffload_options_ = 1308,              /* -foffload-options= */
  ...
  OPT_gbtf = 1632,                           /* -gbtf */
  OPT_gcoff = 1633,                          /* -gcoff */
  OPT_gcoff1 = 1634,                         /* -gcoff1 */
  OPT_gcoff2 = 1635,                         /* -gcoff2 */
  OPT_gcoff3 = 1636,                         /* -gcoff3 */
  OPT_gcolumn_info = 1637,                   /* -gcolumn-info */
  OPT_gctf = 1638,                           /* -gctf */
  ...
  OPT_list = 1686,                           /* -list */
  OPT_mabi_ = 1687,                          /* -mabi= */
  OPT_mabort_on_noreturn = 1688,             /* -mabort-on-noreturn */
  OPT_mandroid = 1689,                       /* -mandroid */
  ...
  OPT_mbranch_cost_ = 1701,                  /* -mbranch-cost= */
  OPT_mcallee_super_interworking = 1702,     /* -mcallee-super-interworking */
  OPT_mcaller_super_interworking = 1703,     /* -mcaller-super-interworking */
  OPT_mcmse = 1704,                          /* -mcmse */
  OPT_mcpu_ = 1705,                          /* -mcpu= */
  OPT_mfdpic = 1706,                         /* -mfdpic */
  OPT_mfix_cortex_m3_ldrd = 1707,            /* -mfix-cortex-m3-ldrd */
  OPT_mflip_thumb = 1708,                    /* -mflip-thumb */
  OPT_mfloat_abi_ = 1709,                    /* -mfloat-abi= */
  OPT_mfp16_format_ = 1710,                  /* -mfp16-format= */
  OPT_mfpu_ = 1711,                          /* -mfpu= */
  OPT_mgeneral_regs_only = 1712,             /* -mgeneral-regs-only */
  OPT_mglibc = 1713,                         /* -mglibc */
  /* OPT_mhard_float = 1714, */              /* -mhard-float */
  OPT_mlibarch_ = 1715,                      /* -mlibarch= */
  OPT_mlittle_endian = 1716,                 /* -mlittle-endian */
  OPT_mlong_calls = 1717,                    /* -mlong-calls */
  OPT_mmusl = 1718,                          /* -mmusl */
  OPT_mneon_for_64bits = 1719,               /* -mneon-for-64bits */
  OPT_mpic_data_is_text_relative = 1720,     /* -mpic-data-is-text-relative */
  OPT_mpic_register_ = 1721,                 /* -mpic-register= */
  OPT_mpoke_function_name = 1722,            /* -mpoke-function-name */
  OPT_mprint_tune_info = 1723,               /* -mprint-tune-info */
  OPT_mpure_code = 1724,                     /* -mpure-code */
  OPT_mrestrict_it = 1725,                   /* -mrestrict-it */
  OPT_msched_prolog = 1726,                  /* -msched-prolog */
  OPT_msingle_pic_base = 1727,               /* -msingle-pic-base */
  OPT_mslow_flash_data = 1728,               /* -mslow-flash-data */
  /* OPT_msoft_float = 1729, */              /* -msoft-float */
  OPT_mstructure_size_boundary_ = 1730,      /* -mstructure-size-boundary= */
  OPT_mthumb = 1731,                         /* -mthumb */
  OPT_mthumb_interwork = 1732,               /* -mthumb-interwork */
  OPT_mtls_dialect_ = 1733,                  /* -mtls-dialect= */
  OPT_mtp_ = 1734,                           /* -mtp= */
  OPT_mtpcs_frame = 1735,                    /* -mtpcs-frame */
  OPT_mtpcs_leaf_frame = 1736,               /* -mtpcs-leaf-frame */
  ...
  OPT_pie = 1764,                            /* -pie */
  OPT_pipe = 1765,                           /* -pipe */
  OPT_posix = 1766,                          /* -posix */
  OPT_print_file_name_ = 1767,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1768,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1769,          /* -print-multi-directory */
  OPT_print_multi_lib = 1770,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1771,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1772,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1773,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1774,               /* -print-prog-name= */
  OPT_print_search_dirs = 1775,              /* -print-search-dirs */
  OPT_print_sysroot = 1776,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1777,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 1778,                    /* -print-value */
  OPT_profile = 1779,                        /* -profile */
  OPT_pthread = 1780,                        /* -pthread */
  OPT_quiet = 1781,                          /* -quiet */
  OPT_r = 1782,                              /* -r */
  OPT_rdynamic = 1783,                       /* -rdynamic */
  ...
  OPT_time = 1869,                           /* -time */
  OPT_time_ = 1870,                          /* -time= */
  OPT_tno_android_cc = 1871,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1872,                 /* -tno-android-ld */
  OPT_traditional = 1873,                    /* -traditional */
  OPT_traditional_cpp = 1874,                /* -traditional-cpp */
  OPT_tree_stats = 1875,                     /* -tree-stats */
  OPT_trigraphs = 1876,                      /* -trigraphs */
  OPT_type_stats = 1877,                     /* -type-stats */
  OPT_u = 1878,                              /* -u */
  OPT_undef = 1879,                          /* -undef */
  OPT_v = 1880,                              /* -v */
  OPT_version = 1881,                        /* -version */
  OPT_w = 1882,                              /* -w */
  OPT_wrapper = 1883,                        /* -wrapper */
  OPT_x = 1884,                              /* -x */
  OPT_z = 1885,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
