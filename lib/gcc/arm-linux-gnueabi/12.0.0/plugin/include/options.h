...
enum opt_code
{
  ...
  OPT_fmove_loop_stores = 1285,              /* -fmove-loop-stores */
  OPT_fms_extensions = 1286,                 /* -fms-extensions */
  OPT_fmudflap = 1287,                       /* -fmudflap */
  OPT_fmudflapir = 1288,                     /* -fmudflapir */
  OPT_fmudflapth = 1289,                     /* -fmudflapth */
  OPT_fname_mangling_version_ = 1290,        /* -fname-mangling-version- */
  OPT_fnew_abi = 1291,                       /* -fnew-abi */
  OPT_fnew_inheriting_ctors = 1292,          /* -fnew-inheriting-ctors */
  OPT_fnew_ttp_matching = 1293,              /* -fnew-ttp-matching */
  OPT_fnext_runtime = 1294,                  /* -fnext-runtime */
  OPT_fnil_receivers = 1295,                 /* -fnil-receivers */
  OPT_fno_modules = 1296,                    /* -fno-modules */
  OPT_fnon_call_exceptions = 1297,           /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 1298,              /* -fnonansi-builtins */
  OPT_fnonnull_objects = 1299,               /* -fnonnull-objects */
  OPT_fnothrow_opt = 1300,                   /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 1301,             /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 1302,          /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 1303,          /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 1304,               /* -fobjc-exceptions */
  OPT_fobjc_gc = 1305,                       /* -fobjc-gc */
  OPT_fobjc_nilcheck = 1306,                 /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 1307,          /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 1308,                /* -fobjc-std=objc1 */
  OPT_foffload_abi_ = 1309,                  /* -foffload-abi= */
  OPT_foffload_options_ = 1310,              /* -foffload-options= */
  ...
  OPT_list = 1688,                           /* -list */
  OPT_mabi_ = 1689,                          /* -mabi= */
  OPT_mabort_on_noreturn = 1690,             /* -mabort-on-noreturn */
  OPT_mandroid = 1691,                       /* -mandroid */
  OPT_mapcs = 1692,                          /* -mapcs */
  OPT_mapcs_frame = 1693,                    /* -mapcs-frame */
  OPT_mapcs_reentrant = 1694,                /* -mapcs-reentrant */
  OPT_mapcs_stack_check = 1695,              /* -mapcs-stack-check */
  OPT_march_ = 1696,                         /* -march= */
  OPT_marm = 1697,                           /* -marm */
  OPT_masm_syntax_unified = 1698,            /* -masm-syntax-unified */
  OPT_mbe32 = 1699,                          /* -mbe32 */
  OPT_mbe8 = 1700,                           /* -mbe8 */
  ...
  OPT_mfix_cortex_m3_ldrd = 1709,            /* -mfix-cortex-m3-ldrd */
  OPT_mflip_thumb = 1710,                    /* -mflip-thumb */
  OPT_mfloat_abi_ = 1711,                    /* -mfloat-abi= */
  OPT_mfp16_format_ = 1712,                  /* -mfp16-format= */
  OPT_mfpu_ = 1713,                          /* -mfpu= */
  OPT_mgeneral_regs_only = 1714,             /* -mgeneral-regs-only */
  OPT_mglibc = 1715,                         /* -mglibc */
  ...
  OPT_mneon_for_64bits = 1721,               /* -mneon-for-64bits */
  OPT_mpic_data_is_text_relative = 1722,     /* -mpic-data-is-text-relative */
  OPT_mpic_register_ = 1723,                 /* -mpic-register= */
  OPT_mpoke_function_name = 1724,            /* -mpoke-function-name */
  OPT_mprint_tune_info = 1725,               /* -mprint-tune-info */
  OPT_mpure_code = 1726,                     /* -mpure-code */
  OPT_mrestrict_it = 1727,                   /* -mrestrict-it */
  OPT_msched_prolog = 1728,                  /* -msched-prolog */
  OPT_msingle_pic_base = 1729,               /* -msingle-pic-base */
  OPT_mslow_flash_data = 1730,               /* -mslow-flash-data */
  /* OPT_msoft_float = 1731, */              /* -msoft-float */
  OPT_mstructure_size_boundary_ = 1732,      /* -mstructure-size-boundary= */
  OPT_mthumb = 1733,                         /* -mthumb */
  OPT_mthumb_interwork = 1734,               /* -mthumb-interwork */
  OPT_mtls_dialect_ = 1735,                  /* -mtls-dialect= */
  OPT_mtp_ = 1736,                           /* -mtp= */
  OPT_mtpcs_frame = 1737,                    /* -mtpcs-frame */
  OPT_mtpcs_leaf_frame = 1738,               /* -mtpcs-leaf-frame */
  OPT_mtune_ = 1739,                         /* -mtune= */
  OPT_muclibc = 1740,                        /* -muclibc */
  OPT_munaligned_access = 1741,              /* -munaligned-access */
  OPT_mvectorize_with_neon_double = 1742,    /* -mvectorize-with-neon-double */
  OPT_mvectorize_with_neon_quad = 1743,      /* -mvectorize-with-neon-quad */
  OPT_mverbose_cost_dump = 1744,             /* -mverbose-cost-dump */
  OPT_mword_relocations = 1745,              /* -mword-relocations */
  OPT_n = 1746,                              /* -n */
  OPT_name_sort = 1747,                      /* -name-sort */
  OPT_no_canonical_prefixes = 1748,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1749,              /* -no-integrated-cpp */
  OPT_no_pie = 1750,                         /* -no-pie */
  OPT_nocpp = 1751,                          /* -nocpp */
  OPT_nodefaultlibs = 1752,                  /* -nodefaultlibs */
  OPT_nolibc = 1753,                         /* -nolibc */
  OPT_nophoboslib = 1754,                    /* -nophoboslib */
  OPT_nostartfiles = 1755,                   /* -nostartfiles */
  OPT_nostdinc = 1756,                       /* -nostdinc */
  OPT_nostdinc__ = 1757,                     /* -nostdinc++ */
  OPT_nostdlib = 1758,                       /* -nostdlib */
  OPT_o = 1759,                              /* -o */
  OPT_objects = 1760,                        /* -objects */
  OPT_p = 1761,                              /* -p */
  OPT_pass_exit_codes = 1762,                /* -pass-exit-codes */
  /* OPT_pedantic = 1763, */                 /* -pedantic */
  OPT_pedantic_errors = 1764,                /* -pedantic-errors */
  OPT_pg = 1765,                             /* -pg */
  OPT_pie = 1766,                            /* -pie */
  OPT_pipe = 1767,                           /* -pipe */
  OPT_posix = 1768,                          /* -posix */
  OPT_print_file_name_ = 1769,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1770,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1771,          /* -print-multi-directory */
  OPT_print_multi_lib = 1772,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1773,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1774,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1775,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1776,               /* -print-prog-name= */
  OPT_print_search_dirs = 1777,              /* -print-search-dirs */
  OPT_print_sysroot = 1778,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1779,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 1780,                    /* -print-value */
  OPT_profile = 1781,                        /* -profile */
  OPT_pthread = 1782,                        /* -pthread */
  OPT_quiet = 1783,                          /* -quiet */
  OPT_r = 1784,                              /* -r */
  OPT_rdynamic = 1785,                       /* -rdynamic */
  OPT_remap = 1786,                          /* -remap */
  OPT_reverse_sort = 1787,                   /* -reverse-sort */
  OPT_s = 1788,                              /* -s */
  OPT_save_temps = 1789,                     /* -save-temps */
  OPT_save_temps_ = 1790,                    /* -save-temps= */
  OPT_shared = 1791,                         /* -shared */
  OPT_shared_libgcc = 1792,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1793,               /* -shared-libphobos */
  OPT_size_sort = 1794,                      /* -size-sort */
  /* OPT_specs = 1795, */                    /* -specs */
  OPT_specs_ = 1796,                         /* -specs= */
  OPT_static = 1797,                         /* -static */
  OPT_static_libasan = 1798,                 /* -static-libasan */
  OPT_static_libgcc = 1799,                  /* -static-libgcc */
  OPT_static_libgfortran = 1800,             /* -static-libgfortran */
  OPT_static_libgo = 1801,                   /* -static-libgo */
  OPT_static_libhwasan = 1802,               /* -static-libhwasan */
  OPT_static_liblsan = 1803,                 /* -static-liblsan */
  OPT_static_libmpx = 1804,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1805,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 1806,               /* -static-libphobos */
  OPT_static_libstdc__ = 1807,               /* -static-libstdc++ */
  OPT_static_libtsan = 1808,                 /* -static-libtsan */
  OPT_static_libubsan = 1809,                /* -static-libubsan */
  OPT_static_pie = 1810,                     /* -static-pie */
  /* OPT_std_c__03 = 1811, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1812, */                /* -std=c++0x */
  OPT_std_c__11 = 1813,                      /* -std=c++11 */
  OPT_std_c__14 = 1814,                      /* -std=c++14 */
  OPT_std_c__17 = 1815,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1816, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1817, */                /* -std=c++1z */
  OPT_std_c__20 = 1818,                      /* -std=c++20 */
  OPT_std_c__23 = 1819,                      /* -std=c++23 */
  /* OPT_std_c__2a = 1820, */                /* -std=c++2a */
  /* OPT_std_c__2b = 1821, */                /* -std=c++2b */
  OPT_std_c__98 = 1822,                      /* -std=c++98 */
  OPT_std_c11 = 1823,                        /* -std=c11 */
  OPT_std_c17 = 1824,                        /* -std=c17 */
  /* OPT_std_c18 = 1825, */                  /* -std=c18 */
  /* OPT_std_c1x = 1826, */                  /* -std=c1x */
  OPT_std_c2x = 1827,                        /* -std=c2x */
  /* OPT_std_c89 = 1828, */                  /* -std=c89 */
  OPT_std_c90 = 1829,                        /* -std=c90 */
  OPT_std_c99 = 1830,                        /* -std=c99 */
  /* OPT_std_c9x = 1831, */                  /* -std=c9x */
  OPT_std_f2003 = 1832,                      /* -std=f2003 */
  OPT_std_f2008 = 1833,                      /* -std=f2008 */
  OPT_std_f2008ts = 1834,                    /* -std=f2008ts */
  OPT_std_f2018 = 1835,                      /* -std=f2018 */
  OPT_std_f95 = 1836,                        /* -std=f95 */
  OPT_std_gnu = 1837,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1838, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1839, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1840,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1841,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1842,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1843, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1844, */              /* -std=gnu++1z */
  OPT_std_gnu__20 = 1845,                    /* -std=gnu++20 */
  OPT_std_gnu__23 = 1846,                    /* -std=gnu++23 */
  /* OPT_std_gnu__2a = 1847, */              /* -std=gnu++2a */
  /* OPT_std_gnu__2b = 1848, */              /* -std=gnu++2b */
  OPT_std_gnu__98 = 1849,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1850,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1851,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1852, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1853, */                /* -std=gnu1x */
  OPT_std_gnu2x = 1854,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 1855, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1856,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1857,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1858, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1859, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1860,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1861, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1862, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1863, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1864, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1865, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1866,                     /* -std=legacy */
  OPT_stdlib_ = 1867,                        /* -stdlib= */
  OPT_symbol_ = 1868,                        /* -symbol= */
  OPT_symbolic = 1869,                       /* -symbolic */
  OPT_t = 1870,                              /* -t */
  OPT_time = 1871,                           /* -time */
  OPT_time_ = 1872,                          /* -time= */
  OPT_tno_android_cc = 1873,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1874,                 /* -tno-android-ld */
  OPT_traditional = 1875,                    /* -traditional */
  OPT_traditional_cpp = 1876,                /* -traditional-cpp */
  OPT_tree_stats = 1877,                     /* -tree-stats */
  OPT_trigraphs = 1878,                      /* -trigraphs */
  OPT_type_stats = 1879,                     /* -type-stats */
  OPT_u = 1880,                              /* -u */
  OPT_undef = 1881,                          /* -undef */
  OPT_v = 1882,                              /* -v */
  OPT_version = 1883,                        /* -version */
  OPT_w = 1884,                              /* -w */
  OPT_wrapper = 1885,                        /* -wrapper */
  OPT_x = 1886,                              /* -x */
  OPT_z = 1887,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
